        ...
        for i in range(int(len(u[0, :]))):
            ...
            if first_response_flag is False and i == list_of_start[-1] + 86:
                ...
                if batch_end >= int(len(u[0, :])):
                    ...
                    y_next[0, 0] = y[0, batch_start + 49 - delay]
...
class Physical_reservoir(Process_excel):
    ...
    def test(self, Wout):
        ...
        ax2.plot(self.u1_train[0, 0, :], label="ch1")
        ax2.plot(self.u1_train[0, 1, :], label="ch2")
        ax2.plot(self.u1_train[0, 2, :], label="ch3")
        ax2.plot(self.u1_train[0, 3, :], label="ch4")
        ax2.plot(self.u1_train[0, 4, :], label="ch5")
        ax2.plot(self.u1_train[0, 5, :], label="ch6")
        ax2.plot(self.u1_train[0, 6, :], label="ch7")
        ax2.plot(self.u1_train[0, 7, :], label="ch8")
        ax2.plot(self.u1_train[0, 8, :], label="ch9")
        ax2.plot(self.u1_train[0, 9, :], label="ch10")
        ax2.plot(self.u1_train[0, 10, :], label="ch11")
        ax2.plot(self.u1_train[0, 11, :], label="ch12")
        ax2.plot(self.u1_train[0, 12, :], label="ch13")
        ax2.plot(self.u1_train[0, 13, :], label="ch14")
        ax2.plot(self.u1_train[0, 14, :], label="ch15")
        ax2.plot(self.u1_train[0, 15, :], label="ch16")
        ax2.plot(self.u1_train[0, 16, :], label="ch17")
        ax2.plot(self.u1_train[0, 17, :], label="ch18")
        ax2.plot(self.u1_train[0, 18, :], label="ch19")
        ax2.plot(self.u1_train[0, 19, :], label="ch20")
        ax2.plot(self.u1_train[0, 20, :], label="ch21")
        ax2.plot(self.u1_train[0, 21, :], label="ch22")
        ax2.plot(self.u1_train[0, 22, :], label="ch23")
        ax2.plot(self.u1_train[0, 23, :], label="ch24")
        ax2.plot(self.u1_train[0, 24, :], label="ch25")
        ax2.plot(self.u1_train[0, 25, :], label="ch26")
        ax2.plot(self.u1_train[0, 26, :], label="ch27")
        ax2.plot(self.u1_train[0, 27, :], label="ch28")
        ax2.plot(self.u1_train[0, 28, :], label="ch29")
        ax2.plot(self.u1_train[0, 29, :], label="ch30")
        ax2.plot(self.u1_train[0, 30, :], label="ch31")
        ax2.plot(self.u1_train[0, 31, :], label="ch32")
        ax2.plot(self.u1_train[0, 32, :], label="ch33")
        ax2.plot(self.u1_train[0, 33, :], label="ch34")
        ax2.plot(self.u1_train[0, 34, :], label="ch35")
        ax2.plot(self.u1_train[0, 35, :], label="ch36")
        ...
        ax2.plot(self.u1_train[652, 0, :], label="ch1")
        ax2.plot(self.u1_train[652, 1, :], label="ch2")
        ax2.plot(self.u1_train[652, 2, :], label="ch3")
        ax2.plot(self.u1_train[652, 3, :], label="ch4")
        ax2.plot(self.u1_train[652, 4, :], label="ch5")
        ax2.plot(self.u1_train[652, 5, :], label="ch6")
        ax2.plot(self.u1_train[652, 6, :], label="ch7")
        ax2.plot(self.u1_train[652, 7, :], label="ch8")
        ax2.plot(self.u1_train[652, 8, :], label="ch9")
        ax2.plot(self.u1_train[652, 9, :], label="ch10")
        ax2.plot(self.u1_train[652, 10, :], label="ch11")
        ax2.plot(self.u1_train[652, 11, :], label="ch12")
        ax2.plot(self.u1_train[652, 12, :], label="ch13")
        ax2.plot(self.u1_train[652, 13, :], label="ch14")
        ax2.plot(self.u1_train[652, 14, :], label="ch15")
        ax2.plot(self.u1_train[652, 15, :], label="ch16")
        ax2.plot(self.u1_train[652, 16, :], label="ch17")
        ax2.plot(self.u1_train[652, 17, :], label="ch18")
        ax2.plot(self.u1_train[652, 18, :], label="ch19")
        ax2.plot(self.u1_train[652, 19, :], label="ch20")
        ax2.plot(self.u1_train[652, 20, :], label="ch21")
        ax2.plot(self.u1_train[652, 21, :], label="ch22")
        ax2.plot(self.u1_train[652, 22, :], label="ch23")
        ax2.plot(self.u1_train[652, 23, :], label="ch24")
        ax2.plot(self.u1_train[652, 24, :], label="ch25")
        ax2.plot(self.u1_train[652, 25, :], label="ch26")
        ax2.plot(self.u1_train[652, 26, :], label="ch27")
        ax2.plot(self.u1_train[652, 27, :], label="ch28")
        ax2.plot(self.u1_train[652, 28, :], label="ch29")
        ax2.plot(self.u1_train[652, 29, :], label="ch30")
        ax2.plot(self.u1_train[652, 30, :], label="ch31")
        ax2.plot(self.u1_train[652, 31, :], label="ch32")
        ax2.plot(self.u1_train[652, 32, :], label="ch33")
        ax2.plot(self.u1_train[652, 33, :], label="ch34")
        ax2.plot(self.u1_train[652, 34, :], label="ch35")
        ax2.plot(self.u1_train[652, 35, :], label="ch36")
        ax2.set_xlabel(xl, fontsize=16)
        ax2.set_ylabel('processed value', fontsize=16)
        ax2.tick_params(labelsize=16)
        plt.tight_layout()
